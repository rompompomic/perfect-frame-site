...
const Footer = () => {
  return (
    <footer className="w-full bg-nikami-dark px-4 sm:px-6 lg:px-28 py-8 sm:py-10">
      <div className="flex flex-col gap-8 sm:gap-10 mb-8 sm:mb-10">
        {/* Top row: Logo + contact & columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-16">
          {/* Logo and contact */}
          <div className="flex flex-col gap-6 sm:gap-8">
            <img src={logoWhite} alt="NIKAMI logo" className="w-24 sm:w-28 h-auto object-contain" />
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <Phone className="w-5 h-5 text-nikami-blue" fill="currentColor" strokeWidth={0} />
                <span className="text-primary-foreground text-sm sm:text-base font-medium">371 28 60 1111</span>
              </div>
              <div className="flex items-center gap-2">
                <img src={mapPinIcon} alt="Location" className="w-5 h-5" />
                <span className="text-primary-foreground text-sm sm:text-base font-medium">Kaudzīšu iela 59</span>
              </div>
              <div className="flex items-center gap-2">
                <img src={emailIcon} alt="Email" className="w-5 h-5" />
                <span className="text-primary-foreground text-sm sm:text-base font-medium">klienti@nikami.lv</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            <span className="text-primary-foreground/40 text-sm sm:text-base font-bold">Pakalpojumi</span>
            <div className="flex flex-col gap-3 sm:gap-4">
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">Konteineru noma</span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">Atkritumu nodošana laukumā</span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">Šķirošanas laukums</span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">Būvgružu pārstrāde</span>
            </div>
          </div>

          {/* Par uzņēmumu */}
          <div className="flex flex-col gap-4 sm:gap-5">
            <span className="text-primary-foreground/40 text-sm sm:text-base font-bold">Par uzņēmumu</span>
            <div className="flex flex-col gap-3 sm:gap-4">
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">Kontakti</span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">Norēķini</span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">Rekvizīti</span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 sm:gap-8">
            <div className="flex flex-col gap-4 sm:gap-5">
              <span className="text-primary-foreground text-lg sm:text-xl font-bold">Darba laiks</span>
              <div className="flex flex-col gap-2 sm:gap-3">
                <div className="flex items-center gap-2">
                  <span className="text-primary-foreground text-sm sm:text-base font-medium">P. - Pk.:</span>
                  <span className="text-primary-foreground text-sm sm:text-base font-bold">8:00 - 17:00</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-primary-foreground text-sm sm:text-base font-medium">S.:</span>
                  <span className="text-primary-foreground text-sm sm:text-base font-bold">8:00 - 12:30</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-primary-foreground text-sm sm:text-base font-medium">Sv.:</span>
                  <span className="text-primary-foreground text-sm sm:text-base font-bold">Pēc vienošanās</span>
                </div>
              </div>
            </div>

            <div className="flex flex-col gap-2">
              <span className="text-primary-foreground text-sm sm:text-base font-bold">Seko mums:</span>
      ...
      {/* Bottom */}
      <div className="border-t border-primary-foreground/20 pt-4 sm:pt-5 flex flex-col sm:flex-row justify-between items-center gap-4">
        <span className="text-primary-foreground/40 text-sm sm:text-base font-medium text-center sm:text-left">
