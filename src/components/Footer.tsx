      ...
      <div className="flex flex-col gap-8 sm:gap-10 mb-8 sm:mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-16">
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            <span className="text-primary-foreground/40 text-sm sm:text-base font-bold">
              {t("footer.services")}
            </span>
            <div className="flex flex-col gap-3 sm:gap-4">
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">
                {t("footer.serviceLinks.containerRental")}
              </span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">
                {t("footer.serviceLinks.wasteDelivery")}
              </span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">
                {t("footer.serviceLinks.sortingArea")}
              </span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">
                {t("footer.serviceLinks.constructionWaste")}
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">
                {t("footer.companyLinks.contacts")}
              </span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">
                {t("footer.companyLinks.payments")}
              </span>
              <span className="text-primary-foreground text-sm sm:text-base font-medium cursor-pointer hover:opacity-80">
                {t("footer.companyLinks.details")}
              </span>
            </div>
          </div>
