      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-28 mb-10">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4">
            <span className="text-primary-foreground text-base font-medium cursor-pointer hover:opacity-80">Konteineru noma</span>
            <span className="text-primary-foreground text-base font-medium cursor-pointer hover:opacity-80">Atkritumu nodošana laukumā</span>
            <span className="text-primary-foreground text-base font-medium cursor-pointer hover:opacity-80">Šķirošanas laukums</span>
            <span className="text-primary-foreground text-base font-medium cursor-pointer hover:opacity-80">Būvgružu pārstrāde</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4">
            <span className="text-primary-foreground text-base font-medium cursor-pointer hover:opacity-80">Kontakti</span>
            <span className="text-primary-foreground text-base font-medium cursor-pointer hover:opacity-80">Norēķini</span>
            <span className="text-primary-foreground text-base font-medium cursor-pointer hover:opacity-80">Rekvizīti</span>
          </div>
        </div>
