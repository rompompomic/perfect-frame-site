...
const AboutMapSection = () => {
  ...
  return (
    <section className="w-full relative min-h-[300px] sm:min-h-[384px]">
      ...
      {/* Floating info card */}
      <div className="absolute top-1/2 -translate-y-1/2 right-2 sm:right-6 md:right-12 lg:right-24 w-[220px] sm:w-[90%] md:w-[500px] lg:w-[598px] p-2 sm:p-5 bg-primary flex flex-col gap-1.5 sm:gap-5 overflow-hidden z-10">
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            <label className="flex items-start gap-2 cursor-pointer">
              <input type="checkbox" defaultChecked className="w-6 h-6 accent-nikami-blue border-2 border-nikami-blue rounded-sm appearance-none checked:appearance-auto shrink-0 mt-0.5" style={{ borderColor: 'hsl(var(--nikami-blue))' }} />
