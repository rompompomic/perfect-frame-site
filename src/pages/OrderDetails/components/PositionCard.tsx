...
export const PositionCard: FC<PositionCardProps> = ({ position, variant = "order", defaultOpen }) => {
  const { t } = useTranslation();
  const [open, setOpen] = useState(defaultOpen ?? position.id === "1");
  const isCart = variant === "cart";

  return (
    <div className={`rounded-[8px] overflow-hidden border border-[#dde8f5] ${isCart ? "bg-white" : "bg-[#e8f1fb]"}`}>
      <div
      ...
      >
        ...
        >
          <motion.div animate={{ rotate: open ? 0 : 180 }} transition={{ duration: 0.3, ease: "easeInOut" }}>
            <ChevronUpIcon />
          </motion.div>
        </motion.div>
      </div>
            ...
            >
              ...
              <div className="flex items-center gap-[12px] px-[16px] py-[13px]">
                ...
                <div>
                  ...
                  <p className="text-[#1e293b] text-[13px] font-medium">{position.deliveryAddress}</p>
                </div>
              </div>
                ...
                <div className="flex items-center gap-[12px] px-[16px] py-[13px]">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-[8px] flex-wrap">
                      <p className="text-[#1e293b] text-[13px] font-medium">{position.promo.split(" NEWYEAR")[0]}</p>
