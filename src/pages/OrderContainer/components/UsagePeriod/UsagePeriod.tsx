...
function ContainerPeriodCard({
  ...
  return (
    <div
      ...
      {/* Header */}
      <p className="text-lg sm:text-xl md:text-[26px] px-4 sm:px-6 py-3 font-black text-[#05376D] mb-0.5">
      ...
      {/* Fields row */}
      <div className="flex flex-col sm:flex-row px-4 sm:px-6 py-3 gap-3">
        {/* Service select */}
        ...
        <div className="flex flex-col gap-1 flex-1 min-w-0">
          ...
          <DatePicker
            ...
            className="w-full px-3 py-2.5 text-sm text-[#334155] outline-none bg-transparent cursor-pointer border border-[#4895E8] rounded-[4px] focus:border-[#4895E8] transition-colors"
            minDate={new Date()}
            customInput={
              <div className="relative flex items-center justify-between w-full px-3 py-2.5 text-sm text-[#334155] outline-none bg-transparent cursor-pointer border border-[#4895E8] rounded-[4px] focus:border-[#4895E8] transition-colors">
...
function OrderSummary({
  ...
  return (
    <div className="bg-white rounded-[4px] border border-[#D0DCE8] p-4 sm:p-6">
      <h2 className="text-xl sm:text-2xl md:text-[32px] font-[900] text-[#05376D] uppercase mb-4 sm:mb-5">Pasūtījuma detaļas</h2>
              ...
              {[
                ...
                .map(([label, value]) => (
                  <div key={label} className="flex justify-between items-center py-0.5">
                    <span className="text-xs sm:text-sm font-bold text-[#000]">{label}</span>
      ...
      <div className="border-t border-[#D0DCE8] pt-4">
        <h3 className="text-xl sm:text-2xl md:text-[32px] font-[900] text-[#05376D] uppercase mb-3">Cenas aprēķināšana</h3>
...
export function UsagePeriod({ containers, onBack, onNext }: Props) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center gap-2 mb-6 sm:mb-8 text-[#334155] font-semibold text-sm sm:text-base md:text-[20px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <div>
          ...
          <div className="mt-4 bg-[#787878] rounded-[4px] p-4 sm:p-5">
            <p className="text-lg sm:text-xl md:text-[26px] font-bold text-[#fff] mb-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
        ...
        <button
          ...
          className="flex-1 h-[46px] text-white font-semibold text-sm rounded-[4px] flex items-center relative transition-colors bg-[#05376D] hover:bg-[#15305a]">
