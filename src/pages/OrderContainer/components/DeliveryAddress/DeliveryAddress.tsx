...
function MapPlaceholder({ count }: { count: number }) {
  ...
  return (
    <div className="relative w-full h-[200px] sm:h-[280px] md:h-[340px] bg-[#E8EEF3] rounded-[4px] overflow-hidden border border-[#D0DCE8]">
      ...
      <svg className="absolute inset-0 w-full h-full">
        <path d="M 0 180 Q 300 160 700 200 T 1200 180" fill="none" stroke="#C5D0D8" strokeWidth="6" />
        <path d="M 0 220 Q 200 240 500 210 T 1200 230" fill="none" stroke="#C5D0D8" strokeWidth="4" />
      ...
      {mockPins.map((pin) => (
        <div
          ...
          <svg width="28" height="36" viewBox="0 0 36 44" xmlns="http://www.w3.org/2000/svg" className="w-7 h-9 sm:w-9 sm:h-11">
            <path fill="#4895E8" d="M18 0C8.06 0 0 8.06 0 18c0 13.5 18 26 18 26S36 31.5 36 18C36 8.06 27.94 0 18 0z" />
            <circle cx="18" cy="18" r="11" fill="white" opacity="0.2" />
            <text x="18" y="23" textAnchor="middle" fontSize="13" fontWeight="700" fontFamily="sans-serif" fill="white">
              {pin.label}
            </text>
          </svg>
        </div>
