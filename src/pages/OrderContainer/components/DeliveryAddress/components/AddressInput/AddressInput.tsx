  ...
  return (
    <div className="flex flex-col gap-1 flex-1 min-w-[240px]">
      ...
      <div className="relative flex items-center">
        <div className="absolute left-[20px] opacity-40 pointer-events-none">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <input
          ...
          className="w-full pl-[54px] pr-8 py-3 border border-[#4895E8] rounded-[4px] text-sm text-[#334155] outline-none focus:border-[#4895E8] transition-colors bg-white"
        />
        {value && (
          <button
            onClick={onClear}
            className="absolute right-3 text-[#9AAFBE] hover:text-[#334155] transition-colors text-xl leading-none">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
