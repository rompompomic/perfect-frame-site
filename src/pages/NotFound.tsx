  ...
  return (
    <div className="w-full bg-background flex flex-col min-h-screen">
      ...
      <div className="relative flex-1 min-h-[400px] sm:min-h-[480px] md:min-h-[580px] px-6 sm:px-12 md:px-28 pt-16 sm:pt-20 md:pt-24 pb-16 sm:pb-20 md:pb-24 flex flex-col justify-start items-start gap-8 sm:gap-12 overflow-hidden">
        ...
        <span className="absolute -right-4 sm:-right-8 md:-right-8 lg:-right-12 -bottom-8 sm:-bottom-12 md:-bottom-16 lg:top-[101px] lg:bottom-auto text-[280px] sm:text-[320px] md:text-[380px] lg:text-[565px] font-black uppercase leading-none text-nikami-light-blue select-none pointer-events-none z-0">
          404
        </span>
