...
export default function ProfilePage() {
  ...
  const [profileType] = useState<"individual" | "legal">("legal");
  ...
  return (
    <MainLayout>
      ...
      <div className=" bg-white px-6 py-10 max-w-[1200px] mx-auto">
        <h1 className="text-[48px] font-black text-[#05376D] uppercase tracking-tight mb-8">{t("profile.title")}</h1>
              ...
              <div className="flex items-end gap-2">
                <div className="flex-1">
                  ...
                  <div className="flex items-center border border-[#D0DCE8] rounded-[4px] bg-white px-3 py-2.5 mt-1">
                    <span className="flex-1 text-sm text-[#334155] tracking-widest">••••••••••</span>
                    <button
